...
class BestOffers extends Component {
    ...
    componentDidMount() {
        axios.get(`${KONEKSI}/product/getproductoffer`
        ).then((res) => {
    ...
    render() {
        return(
            <div className=" p-5">
                <h3 className="font-templates mb-5 border-bottom-best">Best Offers This Week</h3>
                <div className="row">
...
export default connect(mapStateToProps)(BestOffers);